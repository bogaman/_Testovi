...
namespace Proba2
{
    ...
    [TestFixture]
    public partial class OsiguranjeVozila : Osiguranje //: PageTest
    {
        ...
        */
        ...
        public async Task _TestTestova()
        {
            ...
            try
            {
                ...
                //await _page.GotoAsync("https://razvojamso-master.eonsystem.rs/BackOffice/BackOffice/1/Putno-osiguranje/3894");
                ...
                */
                ...
                Console.WriteLine($"******************** logFajlSumarni:    {logFajlSumarni}");
                Console.WriteLine($"******************** putanjaDoBaze: {putanjaDoBaze}");
            ...
            try
            {
                using (OleDbConnection konekcija = new OleDbConnection(connectionStringLogovi))
                {
                    konekcija.Open();
            ...
            {
                LogovanjeTesta.LogError($"❌ Greška prilikom upisa u bazu: {ex.Message}");
        ...
        */
            ...
            if (process2 != null)
            {
                ...
                var textBox = mainWindow2.FindFirstDescendant(cf => cf.ByControlType(FlaUI.Core.Definitions.ControlType.Tree)).AsTextBox();

...
echo. > Logovi\_log_AO_Proba2.txt
echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] Proba2.OsiguranjeVozila.AO_7_Otpis... >> Logovi\_log_AO_Proba2.txt
dotnet test --filter FullyQualifiedName=Proba2.OsiguranjeVozila.AO_7_Otpis | findstr /i "Passed" >> Logovi\_log_AO_Proba2.txt 2>&1 

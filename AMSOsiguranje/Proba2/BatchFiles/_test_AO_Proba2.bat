...
::@echo off
set BASE_URL=https://Proba2amso-master.eonsystem.rs
...
echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] _0TestTestova... >> Logovi\_log_AO_Proba2.txt
dotnet test --filter FullyQualifiedName=Proba2.OsiguranjeVozila._0TestTestova | findstr /i "Passed" >> Logovi\_log_AO_Proba2.txt 2>&1 

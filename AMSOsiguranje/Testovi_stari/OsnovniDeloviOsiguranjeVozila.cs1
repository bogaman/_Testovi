...
namespace Razvoj
{
    ...
    public partial class OsiguranjeVozila : Osiguranje
    {
        public async Task<string> ProcitajCeliju(int red, int kolona)
        {
            ...
            {
                LogovanjeTesta.LogException(ex, $"Greška pri čitanju ćelije [red: {red}, kolona: {kolona}]");
                return string.Empty;
            }
        }
        ...
        {
            string putanja = $"{logFolder}\\monitoring_log.txt";
...
*/
        ...
        private static async Task UlogujSe(IPage _page, string KorisnikMejl, string KorisnikPassword)
        {
            try
            {
...
*********************/
        ...
        public async Task ProveraVestPostoji_old(IPage _page, string ocekivaniTekst)
        {
            ...
            {
                LogovanjeTesta.LogException(ex, nazivTekucegTesta);

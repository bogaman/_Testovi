...
echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] Razvoj.TestProbe... >> Logovi\_log_AO_Razvoj.txt
dotnet test --filter FullyQualifiedName=Razvoj.TestProbe | findstr /i "Passed" >> Logovi\_log_AO_Razvoj.txt 2>&1 

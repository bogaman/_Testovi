...
echo. > Logovi\_log_AO_Razvoj.txt
echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] Razvoj.OsiguranjeVozila.AO_6_RazduznaLista... >> Logovi\_log_AO_Razvoj.txt
dotnet test --filter FullyQualifiedName=Razvoj.OsiguranjeVozila.AO_6_RazduznaLista | findstr /i "Passed" >> Logovi\_log_AO_Razvoj.txt 2>&1 

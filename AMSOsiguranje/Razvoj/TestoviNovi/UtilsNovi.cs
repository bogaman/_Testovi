...
namespace Razvoj
{
    public partial class OsiguranjeNovi
    {
        ...
        public static string radniFolder = AppDomain.CurrentDomain.BaseDirectory;
        //public static string radniFolder2 = AppContext.BaseDirectory;

        public static string projektFolder = Directory.GetParent(radniFolder)!.Parent!.Parent!.Parent!.Parent!.FullName;  // Ide 3 nivoa gore
        ...
        public async Task ProveriURL(IPage _page, string OsnovnaStrana, string Dodatak)
        {
            ...
            {
                LogovanjeTestaNovi.LogError($"❌ Greška prilikom učitavanja stranice: - {OsnovnaStrana + Dodatak}\n{ex.Message}");
                throw;
            }
        }
    ...
    public static class FunkcijeNovi
    {

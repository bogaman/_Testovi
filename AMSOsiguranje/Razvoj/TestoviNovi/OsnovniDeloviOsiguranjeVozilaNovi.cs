...
namespace Razvoj
{
    ...
    public partial class OsiguranjeVozilaNovi : OsiguranjeNovi
    {
        public async Task<string> ProcitajCeliju(int red, int kolona)
        {
            ...
            {
                LogovanjeTestaNovi.LogException(ex, $"Greška pri čitanju ćelije [red: {red}, kolona: {kolona}]");
                return string.Empty;
            }
        }
        ...
        {
            string putanja = $"{LogovanjeTestaNovi.LogFolder}\\monitoring_log.txt";
        ...
        static async Task<ZapisOSlanjuMejla> ProcitajPoslednjiZapisMejla()
        {
                    ...
                    using (SqlDataReader reader = command.ExecuteReader())
                    {
                        ...
                        if (reader.Read())
                        {
                            return await Task.FromResult(new ZapisOSlanjuMejla
                            {
                                ...
                                Opis = reader.GetValueOrDefault<string>("Opis", "-"),
                                Datum = reader.GetDateTime(reader.GetOrdinal("Datum")),
                                Subject = reader.GetValueOrDefault<string>("Subject", "-")
            ...
            {
                LogovanjeTestaNovi.LogError($"❌ Greška prilikom čitanja poslednjeg zapisa: {ex.Message}");
                return null;
            }
        }
        ...
        private static async Task ProveriStatusSlanjaMejla(ZapisOSlanjuMejla PrethodniZapisMejla)
        {
            try
            {
                ...
                if (zapis1 != null)
                {
                    ...
                    LogovanjeTestaNovi.LogMessage($"✅ 1 Poslat mejl -> ID: {zapis1.PoslednjiID}, IDMail: {zapis1.PoslednjiIDMail}, Status: {zapis1.Status}, Opis: {zapis1.Opis},  Datum: {zapis1.Datum}, Subject: : {zapis1.Subject}", false);
                }

                else
                {
                    //Loguj("Timeout: Nije stigao mejl sa Status = 1");
                    LogovanjeTestaNovi.LogError("❌ Timeout: Nije stigao mejl sa Status = 1");
                }
                ...
                if (zapis2 != null)
                {
                    ...
                    LogovanjeTestaNovi.LogMessage($"✅ 2 Poslat mejl -> ID: {zapis2.PoslednjiID}, IDMail: {zapis2.PoslednjiIDMail}, Status: {zapis2.Status}, Opis: {zapis2.Opis},  Datum: {zapis2.Datum}, Subject: : {zapis2.Subject}", false);
                }
                else
                {
                    Loguj("Timeout: Nije stigao mejl sa Status = 2");
                    LogovanjeTestaNovi.LogError("❌ Timeout: Nije stigao mejl sa Status = 2");
  ...
  */
        ...
        private static async Task ProveriStampu404(IPage _page, string Dugme, string Poruka)
        {
            ...
            try
            {
                ...
                LogovanjeTestaNovi.LogMessage($"✅ {Poruka} nema 'HTTP ERROR 404'", false);
            }
            catch (AssertionException ex)
            {
                ...
                LogovanjeTestaNovi.LogError($"❌ {Poruka} ima 'HTTP ERROR 404'");
        ...
        private static async Task ProveriStampuPdf(IPage _page, string Dugme, string Poruka)
        {
            ...
            try
            {
                ...
                File.AppendAllText($"C:\\_Projekti\\AutoMotoSavezSrbije\\Logovi\\test_log_AO1.txt", $"+++++++++++++++++++++{DateTime.Now:dd.MM.yyyy HH:mm:ss} {Environment.NewLine}");
                LogovanjeTestaNovi.LogMessage($"✅ {Poruka} završava sa pdf", false);
            }
            catch (AssertionException ex)
            {
                // Upisivanje u fajl
                File.AppendAllText($"C:\\_Projekti\\AutoMotoSavezSrbije\\Logovi\\test_log_AO1.txt", $"--------------------------{DateTime.Now:dd.MM.yyyy HH:mm:ss} - {ex.Message}{Environment.NewLine}");
                LogovanjeTestaNovi.LogError($"❌ {Poruka} ne završava sa pdf");
...
*/
        ...
        public static async Task UlogujSe(IPage _page, string KorisnikMejl, string KorisnikPassword)
        {
            try
            {
                ...
                LogovanjeTestaNovi.LogMessage($"✅ Ulogovan je korisnik: {KorisnikMejl}.", false);
            }
            catch (Exception ex)
            {
                LogovanjeTestaNovi.LogError($"❌ Logovanje korisnika {KorisnikMejl} neuspešno. {ex.Message}");
                throw;
            }
        }

        // Odjavljivanje sa stranice
        private static async Task IzlogujSe(IPage _page)
        {
            try
            {
                ...
                LogovanjeTestaNovi.LogMessage($"✅ Korisnik izlogovan.", false);
                //Trace.WriteLine($"OK");
            ...
            catch (Exception ex)
            {
                ...
                LogovanjeTestaNovi.LogError($"❌ Odjavljivanje korisnika. {ex.Message}");
                throw;
            }
        ...
        private static async Task SnimiDokument(IPage _page, int brDokument, string staSeSnima)
        {
            try
            {
                ...
                LogovanjeTestaNovi.LogMessage($"✅ Snimanje: {staSeSnima}, dokument {brDokument + 1}", false);
                //Trace.WriteLine($"OK");

            }
            catch (Exception ex)
            {
                LogovanjeTestaNovi.LogError($"❌ Snimanje: {staSeSnima}, dokument {brDokument + 1} {ex.Message}");
                throw;
            }
        ...
        public static async Task IzaberiOpcijuIzListe(IPage page, string selektorListe, string vrednostOpcije, bool koristiSelectOption = true)
        {
            try
            {
                ...
                {
                    LogovanjeTestaNovi.LogMessage($"⚠️ Opcija '{vrednostOpcije}' je već selektovana u '{selektorListe}'.", false);
                    return;
                }
                ...
                if (koristiSelectOption)
                {
                    ...
                    if (tagName.ToLower() == "select")
                    {
                        ...
                        LogovanjeTestaNovi.LogMessage($"✅ Opcija '{vrednostOpcije}' izabrana korišćenjem SelectOptionAsync na '{selektorListe}'.", false);
                        return;
                    }
                }
                ...
                LogovanjeTestaNovi.LogMessage($"✅ Opcija '{vrednostOpcije}' selektovana klikom u '{selektorListe}'.", false);
            }
            catch (Exception ex)
            {
                LogovanjeTestaNovi.LogException(ex, $"Greška prilikom izbora opcije '{vrednostOpcije}' u listi '{selektorListe}'");
                throw;
            }
        }
        ...
        private static async Task UnesiMagacin(IPage _page, string selektor)
        {
            try
            {
                ...
                LogovanjeTestaNovi.LogMessage($"✅ Izbor magacina", false);
                //Trace.WriteLine($"OK");

            }
            catch (Exception ex)
            {
                LogovanjeTestaNovi.LogError($"❌ Izbor magacina.\n{ex.Message}");
                throw;
            }
        ...
        private static async Task ObrisiDokument(IPage _page, int brDokument)
        {
            try
            {
                ...
                LogovanjeTestaNovi.LogMessage($"✅ Dokument obrisan: {brDokument + 1}", false);
                //Trace.WriteLine($"OK");

            }
            catch (Exception ex)
            {
                LogovanjeTestaNovi.LogError($"❌ Brisanje dokumenta {brDokument + 1} {ex.Message}");
                throw;
            }
        ...
        private static async Task ProveraPostojiGrid(IPage _page, string lokatorGrid, string tipGrida)
        {
            try
            {
                ...
                LogovanjeTestaNovi.LogMessage($"✅ Grid: {tipGrida} - {lokatorGrid} pronađena.", false);
            }
            catch (Exception ex)
            {
                LogovanjeTestaNovi.LogError($"❌ Grid nije pronađen: {tipGrida} - {lokatorGrid} \\n {ex.Message}");
                throw;
            }
        }
        ...
        private static async Task ProveriPostojanjeKontrole(IPage _page, string kontrola, string tip)
        {
            try
            {
                ...
                LogovanjeTestaNovi.LogMessage($"✅ Kontrola: {tip} - {kontrola} pronađena.", false);
                ...
                LogovanjeTestaNovi.LogMessage("222222222222222222", false);
                
                //else
                //{
                    //Trace.WriteLine($"Pronađena je kontrola: {kontrola} - OK");
                //    LogovanjeTestaNovi.LogMessage($"✅ Postoji kontrola: {tip} -  {kontrola}.", false);
                //}
*********************/
            }
            catch (Exception ex)
            {
                LogovanjeTestaNovi.LogError($"❌ Kontrola nije pronađena: {tip} - {kontrola} \\n {ex.Message}");
                throw;
            }
            // Prekid testiranja
            //Trace.WriteLine($"Nije pronađena kontrola: {kontrola} - Nije OK");
            //LogovanjeTestaNovi.LogError($"❌ 1111111111111Nije pronađena kontrola: - {tip} - {kontrola}");
        ...
        private static async Task ProveriFilterGrida(IPage _page, string kriterijum, string tipGrida)
        {
            ...
            {
                LogovanjeTestaNovi.LogMessage($"✅ Filter na gridu {tipGrida} radi OK", false);
            }
            else
            {
        ...
        public async Task ProveraVestPostoji_old(IPage _page, string ocekivaniTekst)
        {
            try
            {
                ...
                // Loguj rezultat
                LogovanjeTestaNovi.LogMessage($"✅ Stranica sadrži tekst: '{ocekivaniTekst}'", false);
                // Assertuj rezultat
                Assert.That(sadrziTekst, Is.True, $"Tekst '{ocekivaniTekst}' NIJE pronađen na stranici.");
            }
            catch (Exception ex)
            {
                LogovanjeTestaNovi.LogException(ex, nazivTekucegTesta);
                LogovanjeTestaNovi.LogError(nazivTekucegTesta);
                throw;
            }
        }
        public async Task ProveraVestPostoji(IPage _page, string ocekivaniTekst)
        {
            try
            {
                ...
                // Loguj rezultat
                LogovanjeTestaNovi.LogMessage($"✅ Tekst '{ocekivaniTekst}' je pronađen na stranici.", false);
            ...
            catch (TimeoutException)
            {
                ...
                if (!sadrziTekst)
                {
                    ...
                    LogovanjeTestaNovi.LogError(poruka);
                    LogovanjeTestaNovi.LogTestResult(nazivTekucegTesta, false);
                    Assert.Fail(poruka);
                }
                else
                {
                    LogovanjeTestaNovi.LogMessage($"✅ Tekst '{ocekivaniTekst}' je pronađen u fallback proveri.", false);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task ProveraVestJeObrisana(IPage _page, string ocekivaniTekst)
        {
            try
            {
                string sadrzajStranice = await _page.InnerTextAsync("body");
                bool sadrziTekst = sadrzajStranice.Contains(ocekivaniTekst);
                // Loguj rezultat
                LogovanjeTestaNovi.LogMessage($"✅ Vest je obrisana: '{ocekivaniTekst}'", false);
                // Assertuj rezultat
        ...
        private static async Task VestPostoji(IPage _page, string ocekivaniTekst, string oznakaDokumenta)
        {
            ...
            try
            {
                ...
                LogovanjeTestaNovi.LogMessage($"✅ Vest pronađena: {tekst}: {oznakaDokumenta}.", false);
            }
            catch (Exception ex)
            {
                LogovanjeTestaNovi.LogError($"❌ Vest nije pronađena: {tekst}: {oznakaDokumenta}\n {ex.Message}");
                throw;
            }
        }
        ...
        private static async Task VestNePostoji(IPage _page, string ocekivaniTekst, string oznakaDokumenta)
        {
            ...
            {
                await _page.GetByText(tekst).First.ClickAsync();
                LogovanjeTestaNovi.LogMessage($"❌ Vest je pronađena: {tekst}: {oznakaDokumenta}.", false);
            }
            catch (Exception ex)
            {
                LogovanjeTestaNovi.LogMessage($"✅ Vest nije pronađena: {tekst}: {oznakaDokumenta}\n {ex.Message}");
                //throw;
            }
        }
        ...
        private static async Task ArhivirajVest(IPage _page, string ocekivaniTekst, string oznakaDokumenta)
        {
            try
            {
                ...
                LogovanjeTestaNovi.LogMessage($"✅ Vest uspešno arhivirana - {oznakaDokumenta}", false);
            }
            catch (Exception ex)
            {
                LogovanjeTestaNovi.LogError($"❌ Nema vesti za arhiviranje");
                LogovanjeTestaNovi.LogError($"❌ Arhiviranje vesti: {oznakaDokumenta} \n {ex.Message}");
                throw;
            }
        }
        ...
        ***********************/
        ...
        private static long PoslednjiSerijskiStroga(int tipObrasca, string dodatniUslov)
        {
            try
            {
                ...
                LogovanjeTestaNovi.LogMessage($"✅ Poslednji serijski broj obrasca polise AO na svim okruženjima je: {MaksimalniSerijski}.", false);
                return MaksimalniSerijski;

            }
            catch (Exception ex)
            {
                LogovanjeTestaNovi.LogError($"❌ Greška prilikom nalaženja poslednjeg serijskog broja obrasca AO.\n{ex.Message}");
                throw;
            }
        ...
        private static int PoslednjiDokumentStroga()
        {
            try
            {
                ...
                LogovanjeTestaNovi.LogMessage($"✅ Poslednji broj dokumenta u strogoj evidenciji je: {PoslednjiDokument}.", false);
                //Console.WriteLine($"Poslednji broj dokumenta u strogoj evidenciji je: {PoslednjiDokument}.\n");
                return PoslednjiDokument;
            }
            catch (Exception ex)
            {
                LogovanjeTestaNovi.LogError($"❌ Greška prilikom nalaženja broja poslednjeg dokumenta u strogoj evidenciji.\n{ex.Message}");
                throw;
            }

...
::@echo off
set BASE_URL=https://Produkcijaamso-master.eonsystem.rs
...
echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] _0TestTestova... >> Logovi\_log_AO_Produkcija.txt
dotnet test --filter FullyQualifiedName=Produkcija.OsiguranjeVozila._0TestTestova | findstr /i "Passed" >> Logovi\_log_AO_Produkcija.txt 2>&1 

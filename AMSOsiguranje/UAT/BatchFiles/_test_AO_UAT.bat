...
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] UAT.ZTestDevelopment... >> Logovi\_log_AO_UAT.txt
...
echo. >> Logovi\_log_AO_UAT.txt
::dotnet test --filter FullyQualifiedName=UAT.OsiguranjeVozila | findstr /i "Passed" >> Logovi\_log_AO_UAT.txt 2>&1 
::dotnet test --filter "(FullyQualifiedName~UAT.Osiguranje | FullyQualifiedName~UAT.Autoodgovornost | FullyQualifiedName~UAT.KaskoOsiguranje | FullyQualifiedName~UAT.ZeleniKarton | FullyQualifiedName~UAT.JavniSaobracaj | FullyQualifiedName~UAT.DelimicniKasko)" | findstr /i "Passed" >> Logovi\_log_AO_UAT.txt 2>&1 
...
::echo. > Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] AO_1_SE_PregledPretragaObrazaca... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter FullyQualifiedName=UAT.OsiguranjeVozila.AO_1_SE_PregledPretragaObrazaca | findstr /i "Passed" >> Logovi\_log_AO_UAT.txt 2>&1 


::echo. > Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] _TestTestova... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter FullyQualifiedName=UAT.OsiguranjeVozila._TestTestova | findstr /i "Passed" >> Logovi\_log_AO_UAT.txt 2>&1 
...
::echo. >> Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] BO_PutnoZdravstvenoOsiguranje... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter Name=BO_PutnoZdravstvenoOsiguranje >> Logovi\_log_AO_UAT.txt

::echo. >> Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] AO_1_StrogaEvidencija... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter Name=AO_1_StrogaEvidencija >> Logovi\_log_AO_UAT.txt

::echo. >> Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] AO_2_Polisa... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter Name=AO_2_Polisa >> Logovi\_log_AO_UAT.txt

::echo. >> Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] AO_3_ZahtevZaIzmenom... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter Name=AO_3_ZahtevZaIzmenom >> Logovi\_log_AO_UAT.txt

::echo. >> Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] AO_5_RazduznaLista... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter Name=AO_5_RazduznaLista >> Logovi\_log_AO_UAT.txt

::echo. >> Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] AO_6_Otpis... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter Name=AO_6_Otpis >> Logovi\_log_AO_UAT.txt

::echo. >> Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] ZK_StrogaEvidencija... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter Name=ZK_StrogaEvidencija >> Logovi\_log_AO_UAT.txt

::echo. >> Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] ZK_Polisa... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter Name=ZK_Polisa >> Logovi\_log_AO_UAT.txt

::echo. >> Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] ZK_RazduznaLista... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter Name=ZK_RazduznaLista >> Logovi\_log_AO_UAT.txt

::echo. >> Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] ZK_Otpis... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter Name=ZK_Otpis >> Logovi\_log_AO_UAT.txt

::echo. >> Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] JS_Polisa... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter Name=JS_Polisa >> Logovi\_log_AO_UAT.txt

::echo. >> Logovi\_log_AO_UAT.txt
::echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] DK_Polisa... >> Logovi\_log_AO_UAT.txt
::dotnet test --filter Name=DK_Polisa >> Logovi\_log_AO_UAT.txt

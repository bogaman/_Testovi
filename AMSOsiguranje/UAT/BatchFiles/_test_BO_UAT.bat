...
echo. >> Logovi\_log_BO_UAT.txt
echo [%DATE:~4,2%.%DATE:~7,2%.%DATE:~10,4%. %TIME%] PutnePolise... >> Logovi\_log_BO_UAT.txt
dotnet test --filter FullyQualifiedName=UAT.PutnePoliseBO >> Logovi\_log_BO_UAT.txt
